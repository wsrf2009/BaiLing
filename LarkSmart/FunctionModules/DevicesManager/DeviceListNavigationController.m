//
//  DeviceListNavigationController.m
//  CloudBox
//
...
#import "DeviceListNavigationController.h"

@interface DeviceListNavigationController () <UINavigationBarDelegate>

@end

@implementation DeviceListNavigationController
