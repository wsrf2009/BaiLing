...
-(void)addObservers
{
    ...
    [[NSNotificationCenter defaultCenter]  addObserver:self selector:@selector(deviceOrientationDidChange:) name:@"UIDeviceOrientationDidChangeNotification"
     object:nil]; 
...
-(id)initWithViewController:(UIViewController*)viewController
{
    ...
    if(self)
    {
        FPPopoverController *fpp = self;
        fpp.arrowDirection = FPPopoverArrowDirectionAny;
        fpp.view.userInteractionEnabled = YES;
        _touchView = [[FPTouchView alloc] initWithFrame:fpp.view.bounds];
        ...
        [fpp.view addSubview:_touchView];
